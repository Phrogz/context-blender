...
} else addBlendMethod(this.CanvasRenderingContext2D && this.CanvasRenderingContext2D);
...
function addBlendMethod(object){
	...
	var modes = blendOnto.supportedBlendModes = 'normal src-over screen multiply difference src-in plus add overlay hardlight colordodge dodge colorburn burn darken darker lighten lighter exclusion'.split(' ');
